...
def minimize_wasserstein(
    ...
    **kwargs,
    ...
    """
    Minimize the Wasserstein Distance. This works the same as the maximize_loglike
    method, but maximizes the inverse of the Wasserstein Distance.
            ...
            if isinstance(status, dict) and "penalty" in status:
                dashboard.update(
                    ...
                    (
                        ...
                        f"Best WD = {model._cached_loglike_best}, "
                        f"Current Total WD = {status['total_loglike']}, "
                ...
                dashboard.update(
                    f"Iteration {iteration_number:03} {iteration_number_tail}",
                    f"Currently using {method}, Best WD = {model._cached_loglike_best}",
                    model.pf,
                )
            return False
